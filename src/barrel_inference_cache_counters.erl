...
-module(barrel_inference_cache_counters).
-moduledoc """
...
Slot indices are defined in `include/barrel_inference_cache.hrl` as `?C_*`
...
slot_name(?C_HITS_STICKY_PARTIAL) -> hits_sticky_partial;
slot_name(?C_SAVES_AGENT_PREFIX) -> saves_agent_prefix.
