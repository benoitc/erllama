 ...
 * The function bodies live in erllama_chat_nif.cpp; this
 * header is what erllama_nif.c includes so it can:
...
#ifndef ERLLAMA_CHAT_NIF_H
#define ERLLAMA_CHAT_NIF_H
